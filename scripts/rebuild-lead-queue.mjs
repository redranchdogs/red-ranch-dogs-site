...
async function main() {
  ...
  if (!bridgeSupportsCompactLayout) {
    console.warn(
      `Bridge version ${health.version || "unknown"} is live. Redeploy scripts/website-bridge-apps-script.js for compact sheet formatting and bridge-managed notification emails v${EXPECTED_BRIDGE_VERSION}.`
    );
  }
