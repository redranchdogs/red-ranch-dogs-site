...
const checks = [
  ...
  runCommand("Current litter clarity review", "npm", ["run", "review:litter-clarity"]),
  runCommand("Mobile CTA review", "npm", ["run", "review:mobile-ctas"]),
  runCommand("CRM integration checklist", "npm", ["run", "review:crm-integration"]),
  runCommand("Photo day rehearsal", "npm", ["run", "photos:rehearsal"]),
  runCommand("Photo import checklist", "npm", ["run", "photos:import-checklist"]),
