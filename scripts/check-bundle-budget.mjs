...
// Weekly media history is first-party, public content. Keep the budget tight while allowing one full current-litter week.
const maxJsAssetBytes = Number(process.env.BUNDLE_MAX_JS_ASSET_BYTES || 521 * 1024);
