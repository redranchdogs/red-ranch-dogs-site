...
| --- | --- | --- | --- |
| / | Join Waitlist / Apply | Text Us | PASS |
| /puppies/available | Apply for a Puppy | View Current Litters | PASS |
| /puppies/current-litters | Apply for a Puppy | View Upcoming Litters | PASS |
| /apply | Application form | Process context | PASS |
| /contact | Send a Message | Text Us | PASS |
| /guardian-program/application | Guardian Application | Guardian FAQ context | PASS |
