...
- Meadow: personality note is still generic and can be refreshed after the next temperament update.
- Vista: personality note is still generic and can be refreshed after the next temperament update.
- Camper: personality note is still generic and can be refreshed after the next temperament update.
