...
| Whitley + Waylon | 6 | 0 | 6 | 0 | 0 | Waitlist-first language should explain that public openings post after picks. |
| Penny + Wyatt | 6 | 0 | 6 | 0 | 6 | Waitlist-first language should explain that public openings post after picks. |
