# Operations Status
Generated: 6/10/2026, 4:04:49 PM Central
Overall status: **PASS**
## Bridge
Status: **PASS**
Version: 3.2.0
...
| Lead workflow packet | PASS | 4.6s | `npm run leads:packet` |
...
| Image asset review | PASS | 0.2s | `npm run review:images` |
...
| Mobile CTA review | PASS | 0.2s | `npm run review:mobile-ctas` |
| CRM integration checklist | PASS | 0.2s | `npm run review:crm-integration` |
| Photo day rehearsal | PASS | 0.2s | `npm run photos:rehearsal` |
| Photo import checklist | PASS | 0.2s | `npm run photos:import-checklist` |
| Sheet sync review | PASS | 8.0s | `npm run review:sheets` |
...
| Lint | PASS | 1.3s | `npm run lint` |
| Production build | PASS | 2.3s | `npm run build` |
