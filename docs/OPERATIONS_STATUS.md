# Operations Status
Generated: 5/21/2026, 12:43:52 PM Central
Overall status: **PASS**
## Bridge
Status: **PASS**
Version: 3.2.0
...
| Lead workflow packet | PASS | 5.8s | `npm run leads:packet` |
...
| Sheet sync review | PASS | 10.8s | `npm run review:sheets` |
