# Operations Status
Generated: 5/20/2026, 11:51:51 AM Central
Overall status: **PASS**
## Bridge
Status: **PASS**
Version: 3.2.0
...
| Lead workflow packet | PASS | 5.6s | `npm run leads:packet` |
...
| Sheet sync review | PASS | 13.0s | `npm run review:sheets` |
...
| Production build | PASS | 1.3s | `npm run build` |
